...
public class PanelConsumers extends JPanel {
  ...
  private Controller controller;
    ...
    private void createConsumer1()
    {
       ...
       pnlICA.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"C onsumer: x "));
   ...
   private void createConsumer2()
   {
       ...
       pnlCOOP.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"Consumer: xx"));
    ...
    private void createConsumer3()
    {
        ...
        pnlCG.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black),"Consumer: xxx"));
